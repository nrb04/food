        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    "Item Name :        ",
                    React.createElement("input", { type: "text/string", id: "email_inline", "class": "validate", name: "name", placeHolder: "Item Name" }),
                    React.createElement("br", null),
                    "Item Type :        ",
                    React.createElement("input", { type: "text/string", "class": "col-xs-2", id: "ex2", name: "type", placeHolder: " Item Type" }),
                    React.createElement("br", null),
                    "Restaurant Name :  ",
                    React.createElement("input", { type: "text/string", "class": "col-xs-2", id: "ex2", name: "restaurant", placeHolder: " Restaurant Name" }),
                    React.createElement("br", null),
                    "Location :         ",
                    React.createElement("input", { type: "text/string", "class": "col-xs-2", id: "ex2", name: "location", placeHolder: " Restaurant Location" }),
                    React.createElement("br", null),
                    "Price :            ",
                    React.createElement("input", { type: "int", "class": "col-xs-2", id: "ex2", name: "price", placeHolder: "Item Price" }),
                    React.createElement("br", null),
                    React.createElement(
                        "button",
                        { "class": "" },
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { id: "Title" },
                React.createElement(Header, { title: "eNTER FOOD INFORATION" }),
                React.createElement(FormElement, { clearForm: this.clearForm }),
                React.createElement(Header, { title: "YOUR INFORMATION ARE " }),
